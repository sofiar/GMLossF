...
### initialize results
# Bayesian case
theta1_Bay_T100 = matrix(
  nrow = length(res_Bay[[1]]$theta1), ncol = niter,
  dimnames = list(c("mom", "mle", "sp", "mix", "eb"), NULL)
)
theta2_Bay_T100 = theta1_Bay_T100
b_Bay_T100 = theta1_Bay_T100
# frequentist case
theta1_freq_T100 = matrix(
  nrow = length(res_freq[[1]]$theta1), ncol = niter,
  dimnames = list(c("mom", "mle", "sp", "mix", "eb"), NULL)
)
theta2_freq_T100 = theta1_freq_T100
b_freq_T100 = theta1_freq_T100

### fill objects
for (iiter in 1:niter) {
  theta1_Bay_T100[, iiter] = res_Bay[[iiter]]$theta1
  theta2_Bay_T100[, iiter] = res_Bay[[iiter]]$theta2
  b_Bay_T100[, iiter] = res_Bay[[iiter]]$b

  theta1_freq_T100[, iiter] = res_freq[[iiter]]$theta1
  theta2_freq_T100[, iiter] = res_freq[[iiter]]$theta2
  b_freq_T100[, iiter] = res_freq[[iiter]]$b
}
...
################################### Closure ###################################
save(list = ls(), file = "SimStudy_Bay_vs_freq_T100.RData")