...
############### description
# This function approximate the Kolmogorov distribution density. It is used 2 different 
# representations: one for 0 < x < 1.207, the other for x >= 1.207. In both cases the
...
dkolmo = function(x, log = FALSE){
  ...
  # x is the argument where we want to compute the density;
  # log, if it is true then log-density is returned.
