...
# @usage
# exGompPois_flatNIG_mcmc = function(nsim, Nstar, phi1, phi2, eta1, eta2,
...
# @export
exGompPois_flatNIG_mcmc = function(
  ...
  if (!is.infinite(verbose)) {
    print(paste(
      "exGompPois_flatNIG_mcmc: start time at ", Sys.time(), sep = ""
    ))
  }
  ...
  if (!is.infinite(verbose)) {
    print(paste("exGompPois_flatNIG_mcmc: end time at ", Sys.time(), sep = ""))
  }
