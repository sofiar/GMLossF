...
#
# The general Bayesian approach is used; in particular, the composite likelihood
# method is used. Therefore, the following Metropolis algorithm is used
#
...
#
#     (2) sample theta1, theta2, beta | V, W, U using Metropolis algorithm
...
GompPois_UScaledPriors_compositeLike = function(
  ...
  if (is.null(starter)) {
    ...
    starter$IS = c(gse::GompPois_likelihood(
